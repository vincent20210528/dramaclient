<template>
	<el-form ref="formRef" :model="form" :rules="rules" :label-width="options.labelWidth">
		...
		<el-form-item v-if="showSaveButton !== false">
			<el-button type="primary" @click="saveEdit(formRef)">{{ edit ? '保 存' : '新 增' }}</el-button>
		</el-form-item>
	</el-form>
</template>
...
const { options, formData, edit, update, showSaveButton } = defineProps({
	options: {
